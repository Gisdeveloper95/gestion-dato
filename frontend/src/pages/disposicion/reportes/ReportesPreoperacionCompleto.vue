  ...
  <div class="reportes-operacion-page">
    ...
    <div class="page-header">
      <div class="header-content">
        <h1>Reportes Pre-Operación (Completo)</h1>
        ...
        <div class="quick-search-section">
          ...
          <div class="search-input-container">
            ...
            <input 
              ...
              placeholder="🔍 Buscar por código (ej: 54810) o nombre de municipio (ej: TIBU )..."
              class="search-input"
            />
            <button 
...
export default defineComponent({
  name: 'ReportesPreoperacionCompleto',
  ...
  setup() {
    ...
    // Opciones de generación - Solo reportes individuales para preoperacion
    ...
    const busquedaInmediataMunicipios = () => {
      console.log('🔍 Búsqueda inmediata de municipios (PREOPERACION):', busquedaMunicipios.value);
    ...
    const realizarBusquedaMunicipios = async () => {
      try {
        ...
        console.log('🔍 Término de búsqueda (PREOPERACION - usando APIs preoperacion):', terminoBusqueda);
        ...
        console.log(`✅ Búsqueda completada (PREOPERACION): ${municipiosBusqueda.value.length} municipios encontrados`);
        
      } catch (error) {
        console.error('❌ Error en búsqueda de municipios (PREOPERACION):', error);
    ...
    const limpiarBusquedaMunicipios = () => {
      console.log('🧹 Limpiando búsqueda de municipios (PREOPERACION)');
    ...
    const loadInitialData = async () => {
      try {
        ...
        console.log('🔄 Iniciando carga de datos (PREOPERACION - usando APIs preoperacion)...');
        ...
        // Debugging
        console.log('📊 DATOS CARGADOS (PREOPERACION usando preoperacion APIs):');
        ...
        console.error('❌ Error cargando datos (PREOPERACION):', error);
    ...
    // ✅ GENERAR REPORTES - Solo la API de generación es preoperacion
    const generarReportes = async () => {
      ...
      try {
        loading.value = true;
        loadingMessage.value = 'Generando reportes de pre-operación...';
        ...
        // ✅ ÚNICA API DE OPERACION: Solo para generar reportes
        const response = await fetch(`${API_URL}/preoperacion/generar-reportes-completo/`, {
          method: 'POST',
          headers: {
        ...
        link.href = url;
        link.download = `reportes_preoperacion_completo_${new Date().toISOString().split('T')[0]}.zip`;
        ...
        console.error('Error generando reportes (PREOPERACION):', error);
