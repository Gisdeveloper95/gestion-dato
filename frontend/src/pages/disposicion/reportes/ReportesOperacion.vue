...
export default defineComponent({
  ...
  setup() {
    ...
    // Opciones de generación - Solo reportes individuales para postoperacion
    ...
    const busquedaInmediataMunicipios = () => {
      console.log('🔍 Búsqueda inmediata de municipios (OPERACION):', busquedaMunicipios.value);
    ...
    const realizarBusquedaMunicipios = async () => {
      try {
        ...
        console.log('🔍 Término de búsqueda (OPERACION - usando APIs preoperacion):', terminoBusqueda);
        ...
        console.log(`✅ Búsqueda completada (OPERACION): ${municipiosBusqueda.value.length} municipios encontrados`);
        
      } catch (error) {
        console.error('❌ Error en búsqueda de municipios (OPERACION):', error);
    ...
    const limpiarBusquedaMunicipios = () => {
      console.log('🧹 Limpiando búsqueda de municipios (OPERACION)');
    ...
    const loadInitialData = async () => {
      try {
        ...
        console.log('🔄 Iniciando carga de datos (OPERACION - usando APIs preoperacion)...');
        ...
        // Debugging
        console.log('📊 DATOS CARGADOS (OPERACION usando preoperacion APIs):');
        ...
        console.error('❌ Error cargando datos (OPERACION):', error);
    ...
    const generarReportes = async () => {
      ...
      try {
        ...
        console.error('Error generando reportes (OPERACION):', error);
